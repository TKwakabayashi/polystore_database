...
func bulkStorePushdown(qp *QueryProcessor, o *plan.StorePushdown) ([]Row, error) {
	switch o.Store {
	case "graph":
...
func runGraphPushdown(qp *QueryProcessor, query string, params map[string]string) ([]Row, error) {
	if qp.neoDriver == nil {
...
func runRelationalPushdown(qp *QueryProcessor, o *plan.StorePushdown) ([]Row, error) {
	if qp.sqlDb == nil {
		return nil, nil
	}
...
func runDocumentPushdown(qp *QueryProcessor, o *plan.StorePushdown) ([]Row, error) {
	if qp.mDb == nil {
		return nil, nil
	}
...
func runColumnarPushdown(qp *QueryProcessor, o *plan.StorePushdown) ([]Row, error) {
	if qp.cqlSes == nil {
		return nil, nil
	}
